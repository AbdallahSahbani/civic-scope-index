    ...
    <section className="relative h-[85vh] min-h-[600px] w-full overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        >
          <img
            src={heroImage}
            alt="Stone elephant, eagle, and donkey on separate peaks overlooking Washington D.C."
        ...
        >
          ...
          <div className="mt-10 hero-cta">
            <Button
              ...
              size="lg"
              className="bg-white/95 text-primary hover:bg-white px-8 py-6 text-base font-medium shadow-2xl backdrop-blur-sm transition-all duration-300 hover:scale-105"
            >
              Explore the Roster
            </Button>
          </div>
